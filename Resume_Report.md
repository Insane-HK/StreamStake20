# StreamStake20 - Resume Highlights

Below are concise bullet points you can use to highlight this project on your resume. We recommend picking the 2-3 points that best align with the specific job you are applying for.

### **Project Title: StreamStake20 | *Web3 Live Stream Betting Platform***
...
- Deployed smart contracts on the **Monad Testnet** utilizing OpenZeppelin libraries, ensuring rigorous fund security through reentrancy guards and cryptographic signature validation.
- Created a responsive **React (Vite)** frontend with real-time state listeners, seamlessly embedding live video players and dynamic betting interfaces synchronized continuously with the game client state.
